...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        for parent in [mother, father]:
            ...
            percentages[parent] = (1 - PROBS['mutation']) if n_genes == 2 else 0.5 if n_genes == 1 else PROBS['mutation']
...
def normalize(probabilities):
    ...
    for h_type in ['gene', 'trait']:

        for person in probabilities:

            v_sum = sum(probabilities[person][h_type].values())

            for cat in probabilities[person][h_type]:
                normalized[person][h_type][cat] = probabilities[person][h_type][cat] / v_sum
